...
public class MockServiceTest {
    ...
    public void shouldOneTimeRunForChampionArraySize(){
        ...
        // 가짜 객체니까 add하고 size를 출력해도 0이 나온다.
    ...
    @Test
    public void shouldAtLeastTwoTimeRunForChampionGetName(){
        Champion topChamp = mock(Champion.class);
        topChamp.setName("티모");
        topChamp.setPosition("탑");
        topChamp.setHasSkinCount(3);
    ...
    @Test
    public void shouldAtMostThreeTimeRunForChampionGetName(){
        Champion topChamp = mock(Champion.class);
        topChamp.setName("티모");
        topChamp.setPosition("탑");
        topChamp.setHasSkinCount(3);
    ...
    @Test
    public void 챔피언스킨개수() {
        when(mockService.findByName(any(String.class))).thenReturn(new Champion("가렌","탑",4));
        assertThat(mockService.findByName("가렌").getHasSkinCount(),is(4));
